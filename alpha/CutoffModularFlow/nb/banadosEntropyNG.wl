...
(*]*)
(**)
(*(G(\[Delta][qc]-\[Delta]quKarl//ReleaseHold)/.l2lc)/.%//N[#,10]&*)
(**)
...
(*]*)
(**)
(*(G(\[Delta][qc]-\[Delta]quDirichlet//ReleaseHold)/.l2lc/.lvc->luc)/.%//N[#,10]&*)
(**)


(* ::Item:: *)
(*Vary with respect to new lengths*)
...
(* ::Input:: *)
(*lcOldByNew={luc->2u,lvc->2v}/.uvOldByNew/.atCutoff//Simplify*)
...
(*]*)
(**)
(*G \[Delta][qc/.l2lc/.lcOldByNew]/.%//N[#,10]&*)
(*G(\[Delta][qc/.l2lc/.lcOldByNew]-(\[Delta]quDirichlet/.l2lc/.lcOldByNew)//ReleaseHold)/.%%//N[#,10]&*)
(**)


(* ::Input:: *)
(*lcOldByNew/.sameLc//Simplify*)


(* ::Subsubsection::Closed:: *)
(*VI. Integrated charge*)


(* ::Input:: *)
(*dA=-1/(16\[Pi] G) vol contract[*)
(*Normal[LeviCivitaTensor[dim]]**(-covD[lower[\[Xi]]]),*)
(*{1,4},{2,5}*)
(*]//Simplify*)


(* ::Input:: *)
(*dA.{Dt[u],Dt[v],Dt[r]}/.constParams//Simplify*)
(*%/.rRTuv/.constParams;*)
(**)
(*%/.{*)
(*u->1/(2Tu) ArcSinh[t Sinh[Tu lu]],*)
(*v->1/(2Tv) ArcSinh[t Sinh[Tv lv]]*)
(*}/.constParams/.Dt[t]->1//Apart;*)
(**)
(*\[Integral]Evaluate[%]\[DifferentialD]t;*)
(**)
(*%/.{{t->Sinh[Tu luc]/Sinh[Tu lu]},{t->-(Sinh[Tu luc]/Sinh[Tu lu])}};*)
(*%//Apply[Subtract]//Simplify*)
...
(* ::Input:: *)
(*qcIntegrated=-(1/(8 G))(2 Log[1-Csch[lu Tu] Sinh[luc Tu]]-2 Log[1+Csch[lu Tu] Sinh[luc Tu]]+Log[-((Cosh[1/2 (lu-luc) Tu]^2 Sech[1/2 (lu+luc) Tu]^2 (-1+Csch[lu Tu] Sinh[luc Tu] Sinh[lv Tv]^2-Cosh[lv Tv] Sqrt[1+Csch[lu Tu]^2 Sinh[luc Tu]^2 Sinh[lv Tv]^2]))/(1+Csch[lu Tu] Sinh[luc Tu] Sinh[lv Tv]^2+Cosh[lv Tv] Sqrt[1+Csch[lu Tu]^2 Sinh[luc Tu]^2 Sinh[lv Tv]^2]))]);*)
...
(*]*)
(**)
(*G (qcIntegrated-qc)/.l2lc/.%//N[#,10]&*)
(**)


(* ::Subsubsection::Closed:: *)
(*VII. Linear stabilization of the cutoff*)
...
(* ::Input:: *)
(*rScaledLength=#.g.#&[Dt/@coord]/.r->\[Rho]c/rc r/.constParams/.Dt[rc]->0//Simplify*)
(*%/.r->rc/.constParams/.Dt[rc]->0//Simplify*)
(*Coefficient[rScaledLength,Dt[r]^2]//Simplify*)


(* ::Input:: *)
(*r/.karlToBanados/.r->\[Rho]c/rc r/.r->rc//Simplify*)
...
(* ::Input:: *)
(*\[Delta][rScaledLength]/.r->rc/\[Rho]c r/.constParams/.Dt[rc]->0//Simplify*)
(*\[Delta]gScaled=lengthToMetric[%]//ExpandAll//Simplify*)
(**)
(*#.(%/.r->\[Rho]c).#&[Dt/@coord]//Simplify*)


(* ::Item:: *)
(*Integrate along the cutoff:*)


(* ::Input:: *)
(*\[Delta]\[Chi][\[Xi],\[Delta]gScaled].{Dt[u],Dt[v],0}/.constParams//timedSimplify*)


(* ::Input:: *)
(*If[27352304453710247637===$SessionID,%164,Message[Syntax::noinfoker];Missing["NotAvailable"];]*)
...
(* ::Input:: *)
(*\[Delta]dqtScaled=-((-((1/Sqrt[2]) ((((Tu (rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2))) \[Delta]Tv) Cosh[lv Tv]) (rc^4 Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] + Tu^4 Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] + Tv^4 Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] - (Sqrt[2] Tu^2) Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lu Tu]^2)] - (Sqrt[2] Tv^2) Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lu Tu]^2)] + rc^2 (((-2) Tu^2) Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] - (2 Tv^2) Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] + Sqrt[2] Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lu Tu]^2)])))) + (((1/2) ((-(Tu^2 - Tv^2)) ((-Tv) \[Delta]Tu + Tu \[Delta]Tv) + rc^2 (Tv \[Delta]Tu + Tu \[Delta]Tv))) Sqrt[2 - t^2 + t^2 Cosh[(2 lv) Tv]]) (rc^6 Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] - Tu^6 Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] + (Tu^4 Tv^2) Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] + (Tu^2 Tv^4) Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] - Tv^6 Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] + (Sqrt[2] Tu^4) Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lu Tu]^2)] + (Sqrt[2] Tv^4) Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lu Tu]^2)] + rc^4 (((-3) Tu^2) Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] - (3 Tv^2) Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] + Sqrt[2] Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lu Tu]^2)]) + rc^2 ((3 Tu^4) Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] + (3 Tv^4) Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] - ((2 Sqrt[2]) Tv^2) Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lu Tu]^2)] + Tu^2 ((2 Tv^2) Sqrt[2 - t^2 + t^2 Cosh[(2 lu) Tu]] - (2 Sqrt[2]) Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lu Tu]^2)]))) - (1/Sqrt[2]) ((((Tv (rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2))) \[Delta]Tu) Cosh[lu Tu]) (rc^4 Sqrt[2 - t^2 + t^2 Cosh[(2 lv) Tv]] + Tu^4 Sqrt[2 - t^2 + t^2 Cosh[(2 lv) Tv]] + Tv^4 Sqrt[2 - t^2 + t^2 Cosh[(2 lv) Tv]] - (Sqrt[2] Tu^2) Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lv Tv]^2)] - (Sqrt[2] Tv^2) Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lv Tv]^2)] + rc^2 (((-2) Tu^2) Sqrt[2 - t^2 + t^2 Cosh[(2 lv) Tv]] - (2 Tv^2) Sqrt[2 - t^2 + t^2 Cosh[(2 lv) Tv]] + Sqrt[2] Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lv Tv]^2)]))))/(((((((4 G) Tu) Tv) (rc^2 - Tu^2 - Tv^2 + Sqrt[rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)])) (rc^4 + Tu^4 - (2 Tu^2) Tv^2 + Tv^4 - Tu^2 Sqrt[rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)] - Tv^2 Sqrt[rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)] + rc^2 ((-2) Tu^2 - 2 Tv^2 + Sqrt[rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)]))) Sqrt[(rc^4 + (Tu^2 - Tv^2)^2 - (2 rc^2) (Tu^2 + Tv^2)) (1 + t^2 Sinh[lu Tu]^2)]) Sqrt[1 + t^2 Sinh[lv Tv]^2]));*)


(* ::Input:: *)
(*\[Integral]Evaluate[\[Delta]dqtScaled]\[DifferentialD]t;*)
(*%/.{{t->Sinh[Tu luc]/Sinh[Tu lu]},{t->-(Sinh[Tu luc]/Sinh[Tu lu])}};*)
(*%//Apply[Subtract]*)
(*\[Delta]quScaled=(%/.ArcSinh[Csch[lu Tu] Sinh[luc Tu] Sinh[lv Tv]]->lvc Tv)//Simplify*)
...
(*]*)
(**)
(*G (\[Delta]quScaled-\[Delta][qc])/.l2lc/.%//N[#,10]&*)
(**)
