...
\subsection{Type IIB string theory with NS-NS flux}
	...
	The D1-D5-$P$ system is tough to deal with on the worldsheet, within the framework of the RNS (or NSR) formalism, due to its non-trivial coupling to the R-R field $C_2$. This difficulty can be avoided by considering its S-dual, the NS1-NS5-$P$ system. 
	
	
	On the other hand, we can make use of the $\mrm{SL}(2,\mbb{Z})$ duality from type IIB string theory. 
