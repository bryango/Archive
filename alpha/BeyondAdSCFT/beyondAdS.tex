...
\subsubsection{IR limit and the \ads{3} gravity}
	...
	One can understand the IR supergravity solution as the result of ``integrating out'' the dynamics of the branes, including the open string excitations. This process deforms the background geometry, and we end up with a closed string theory on the black string background. \sidenote{......}
	
	
	
\subsubsection{Worldvolume \cft{2} and the duality}
	
	On the other hand, we can consider the worldvolume theory of the brane construction. After dimension reduction of the compact $\mcal{M}_4$, we have a $(1+1)$ dimensional QFT living on the D1-D5 branes. This is a supersymmetric gauge theory with $\mcal{N} = (4,4)$ supersymmetry. 
